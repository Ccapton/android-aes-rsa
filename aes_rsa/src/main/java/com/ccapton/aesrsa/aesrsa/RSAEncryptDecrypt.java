...
public class RSAEncryptDecrypt {
    ...
    public static byte[] encryptRSA(byte[] plain, PublicKey publicKey)
    {
        ...
        System.out.println("RSAEncryptDecrypt.encryptRSA "+(System.currentTimeMillis()-start));
    ...
    public static byte[] decryptRSA(byte[] enc, PrivateKey privateKey)
    {
        ...
        System.out.println("RSAEncryptDecrypt.decryptRSA "+(System.currentTimeMillis()-start));
        return plain;
    }
